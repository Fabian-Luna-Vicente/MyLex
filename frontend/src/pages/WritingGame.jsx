...
export default function WritingGame() {
  ...
  return (
    <div className="min-h-screen bg-[#071320] text-white font-sans relative overflow-hidden">
      ...
      {/* Background Decor */}
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-[#b300ff]/5 blur-[120px] rounded-full"></div>
      ...
      <header className="relative z-10 flex items-center justify-between px-6 md:px-12 pt-8 pb-4 border-b border-[#00c3ff]/20 backdrop-blur-md sticky top-0 bg-[#071320]/80">
        ...
        <h1 className="text-2xl font-extrabold drop-shadow-[0_0_10px_rgba(0,195,255,0.5)] flex items-center gap-2">
          Writing <span className="text-[#b300ff]">Skills</span>
        </h1>
        {showGame ? (
              ...
              {lists.length === 0 ? (
                ...
                <>
                      ...
                      <button
                        ...
                        className={`px-4 py-2.5 rounded-xl text-sm font-bold tracking-wide transition-all border ${
                          selectedListId === list.id
                            ? 'bg-[#b300ff]/20 border-[#b300ff] text-[#b300ff] shadow-[0_0_15px_rgba(179,0,255,0.3)]'
                            : 'bg-[#071320] border-[#00c3ff]/20 text-[#a0a0a0] hover:border-[#b300ff]/50 hover:text-white'
                        }`}
                      >
                        {list.name}
                      </button>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-[#b300ff]/10 to-[#00c3ff]/10 border border-[#b300ff]/50 text-[#b300ff] hover:from-[#b300ff]/20 hover:to-[#00c3ff]/20 shadow-[0_0_20px_rgba(179,0,255,0.2)] font-bold uppercase tracking-wider rounded-full transition-all active:scale-95 disabled:opacity-50"
                  >
                    {loading ? (
                      <div className="h-5 w-5 animate-spin rounded-full border-2 border-[#b300ff] border-t-transparent" />
                    ) : (
            ...
            >
              ...
              <div className="bg-[#0e0c1d]/40 backdrop-blur-md border border-[#ffffff05] rounded-[30px] p-8 shadow-2xl">
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-8">
                  {currentWords.map((word, i) => (
                    <span key={i} className="px-6 py-3 bg-[#b300ff]/10 text-[#b300ff] border border-[#b300ff]/30 rounded-xl font-bold text-lg shadow-[0_0_15px_rgba(179,0,255,0.2)]">
                      {word.name}
                    </span>
                  ))}
                </div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#071320]/80 border border-[#00c3ff]/30 rounded-[20px] p-6 text-white text-lg focus:outline-none focus:border-[#b300ff] focus:ring-1 focus:ring-[#b300ff] transition-all min-h-[150px] resize-y"
                />
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6">
                  ...
                  <button 
                    onClick={nextLevel}
                    className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-white text-black font-black rounded-full hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transition-all uppercase tracking-widest text-sm group"
                  >
              ...
              {aiFeedback && (
                <motion.div 
                  ...
                  className="bg-gradient-to-br from-[#0e0c1d] to-[#071320] border border-[#b300ff]/30 rounded-[30px] p-8 shadow-[0_10px_30px_rgba(179,0,255,0.15)] relative overflow-hidden"
                >
                  <div className="absolute top-0 right-0 p-4 opacity-10">
                    <FaRobot size={100} />
                  </div>
                  
                  <h3 className="text-[#b300ff] font-black uppercase tracking-widest mb-6 flex items-center gap-3 text-sm">
